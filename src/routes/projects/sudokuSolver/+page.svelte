...
<div class="container-lg align-items-center justify-content-center text-center py-4">
  ...
  <p id="sudoku-status" class="lead text-center">enter a puzzle and click solve</p>
  <button type="button" name="button" id="solve-button">Solve</button>
</div>
